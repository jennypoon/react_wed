  ...
  return (
    <div>
      ...
      <div className="questionComponent">
        ...
        <p className="answer">
          Yes! Parking is free. Please print this <a href="https://docs.google.com/document/d/1FIkEgIjHucjm_Y0VeZA-qo69UYID61Srx4NWYGFuEns/edit?usp=sharing" target="_blank">parking pass</a> and place it on your dashboard when you come.
          You can park here:
        </p>
        <br/>
