  ...
  return (
    <div className="venueComponent">
      ...
      <div className="venueDetails">
        ...
        <h3> PARKING </h3>
        <p> Please print this <a href="https://docs.google.com/document/d/1FIkEgIjHucjm_Y0VeZA-qo69UYID61Srx4NWYGFuEns/edit?usp=sharing">parking pass</a> and place it on your dashboard </p>
